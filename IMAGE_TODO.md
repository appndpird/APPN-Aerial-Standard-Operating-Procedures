...
- [ ] **Diagram** · *Explicit* — [Dual ELM panel flight](Protocols/FlightDesign/StandardFlight/Standard_Flight.md#dual-elm-panel-flight): Top-down annotated layout showing panel placements at 1/3 and 2/3 along the long axis, flight-line direction arrows, ~10 % edge-of-polygon buffer, and labelled 5-GCP layout.
- [ ] **Diagram** · *Explicit* — [Single ELM panel flight](Protocols/FlightDesign/StandardFlight/Standard_Flight.md#single-elm-panel-flight): Top-down annotated layout with central ELM panel set, validation panel position, flight-line orientation, edge buffer, and labelled 5-GCP layout.
- [ ] **Diagram** · *Explicit* — [Multi-Flight Capture](Protocols/FlightDesign/StandardFlight/Standard_Flight.md#multi-flight-capture): Sub-flight polygons with overlap zone, shared ELM panel set + 2 tie GCPs in the overlap (highlighted), dual panels per sub-flight, validation panel placement, expanded GCP distribution.
